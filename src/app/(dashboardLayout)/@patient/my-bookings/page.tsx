        ...
        <div className="bg-white dark:bg-[#161617] rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm">
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">View and manage your doctor bookings and sessions.</p>
                </div>

                <div className="flex gap-3">
                    <div className="px-4 py-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
                        <p className="text-[10px] uppercase tracking-wider font-bold text-blue-600">Total Spent</p>
                        <p className="text-lg font-semibold text-blue-600 dark:text-blue-400">${totalSpent}</p>
                    </div>
                ...
                <table className="w-full text-left">
                    <thead className="bg-gray-50 dark:bg-[#1c1c1d] text-[11px] uppercase text-gray-500 dark:text-gray-400 font-bold tracking-wider">
                        <tr>
                            ...
                            <th className="px-6 py-4">Specilaties</th>
